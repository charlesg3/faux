...
set output "/home/cg3/hare/build/graphs/sg.svg"
#set title "{/=20 Scatter Gather}"  font ",20" offset character 0, 0.5, 0
...
color(x) = x > 0 ? 1:2
plot 1 w lines ls 3,\
	"/home/cg3/hare/build/graphs/sg.data" using  (column(0)):($2/$3):(0.5):(color(($2-$3)/$2)):xtic(1) title col w boxes lc variable
