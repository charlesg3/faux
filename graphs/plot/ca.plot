...
set output "/home/cg3/hare/build/graphs/ca.svg"
#set title "{/=20 NUMA}\n{/=12 Creation Affinity, Migrate to large files}"  font ",20" offset character 0, 0.5, 0
...
unset key
#plot "/home/cg3/hare/graphs/data/ca.data" using 2:xtic(1) title col lc rgb 'red', \
...
color(x) = x > 0 ? 1:2
plot 1 w lines ls 3,\
	"/home/cg3/hare/build/graphs/ca.data" using  (column(0)):($2/$3):(0.5):(color(($2-$3)/$2)):xtic(1) title col w boxes lc variable
