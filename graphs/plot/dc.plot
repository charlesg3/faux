...
set output "/home/cg3/hare/build/graphs/dc.svg"
#set title "{/=20 Directory Entry Cache}"  font ",20" offset character 0, 0.5, 0
...
#plot "/home/cg3/hare/graphs/data/dc.data" using 2:xtic(1) title col lc rgb 'red', \
...
color(x) = x > 0 ? 1:2
plot 1 w lines ls 3,\
	"/home/cg3/hare/build/graphs/dc.data" using  (column(0)):($2/$3):(0.5):(color(($2-$3)/$2)):xtic(1) title col w boxes lc variable
