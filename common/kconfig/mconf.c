...
static const char *g_lx_dialog_path = "./scripts/kconfig/lxdialog/lxdialog";

static char menu_backtitle[128];
static const char mconf_readme[] = N_(
"Overview\n"
"--------\n"
"kernel and service configuration for fos.\n"
"\n"
...
int main(int ac, char **av)
{
	...
	if(ac == 3)
	{
		printf("lxdialog path: %s\n", av[2]);
		g_lx_dialog_path = av[2];
	}
	...
	sym_calc_value(sym);
	sprintf(menu_backtitle, _("fos %s Configuration"),
		sym_get_string_value(sym));
